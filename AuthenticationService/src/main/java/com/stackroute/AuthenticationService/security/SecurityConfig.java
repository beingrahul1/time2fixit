...
//import com.stackroute.AuthenticationService.service.CustomTechnicianDetailsService;
//import com.stackroute.AuthenticationService.service.CustomTechnicianDetailsService;
...
//    @Autowired
//    private CustomTechnicianDetailsService technicianDetailsService;
...
//    }
    ...
    http.cors().disable();
    	http.csrf().disable().authorizeRequests().antMatchers("/user/na/**")
